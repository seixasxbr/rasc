...
Para realizar a movimentação do manipulador UR5 utilizamos o Ubuntu 20.04, que foi instalado em um computador Intel NUC 8i7BEH1, também foram utilizados o framework [ROS](https://www.ros.org/) na versão *Noetic*, o [Gazebo](http://gazebosim.org/) e [MoveIt](https://moveit.ros.org/). Também foram utilizados outros algoritmos existentes nestes *frameworks* e *softwares*. 
